...
- 6e277c61: Remove unused code from CTC
- 8560326d: Remove the "OVM" Prefix from contract names
- 33d93f66: Only burn gas in the CTC on deposits with a high gas limit
- 11b3e135: Moves the standards folder out of libraries and into its own top-level folder.
- e7fd4d4c: Removes various unused OVM contracts
- c691d487: Refactors and simplifies OVM_ETH usage
- f93d30d5: Removes the hardhat-ovm plugin and its dependencies
- c67d3f40: Reintroduces the whitelist into the v2 system
- d60af5e7: Removes ERC20 and WETH9 features from OVM_ETH
- 38092bbd: Simplify hierarchy of contracts package
- c74acbe7: Removes unused functions within OVM_BondManager
- 487b3687: Adds refactored support for the L1MESSAGESENDER opcode
- a2697452: Removes all custom genesis initialization
- e72a7f14: Make the CTC's gas burn amount configurable at create time

### Patch Changes

- 41f28c44: Refactor to simplify the process of generating the genesis json file
- fb5d7624: Improves the build process for autogenerated files
- 6844b0e2: Make the standard token factory a predeploy
- ab1ce27e: Added default values library for contracts
- 8a4a7e7a: Removes a bunch of dead testing code in the contracts repo
- 71b31372: Reduces the cost of appendSequencerBatch
- 683d45b7: Assert upper bound on CTC gas costs
- 6a7698d7: Add getter and setter to `OVM_GasPriceOracle` for the l1 base fee
- 456d0ef9: Adds WETH9 at the old OVM_ETH address
- 7a95b7c9: Add a more realistic CTC gas benchmark
- c52e9031: Add gas benchmarks on deposits
