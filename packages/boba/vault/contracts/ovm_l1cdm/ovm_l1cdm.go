...
// OvmL1cdmMetaData contains all meta data concerning the OvmL1cdm contract.
var OvmL1cdmMetaData = &bind.MetaData{
...
// Deprecated: Use OvmL1cdmMetaData.ABI instead.
var OvmL1cdmABI = OvmL1cdmMetaData.ABI
