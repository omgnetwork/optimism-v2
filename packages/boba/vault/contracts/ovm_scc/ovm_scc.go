...
// OvmSccMetaData contains all meta data concerning the OvmScc contract.
var OvmSccMetaData = &bind.MetaData{
...
// Deprecated: Use OvmSccMetaData.ABI instead.
var OvmSccABI = OvmSccMetaData.ABI
