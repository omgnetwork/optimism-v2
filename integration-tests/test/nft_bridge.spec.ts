...
describe('NFT Bridge Test', async () => {
  ...
  describe('L1 native NFT tests', async () => {
    ...
    it('{tag:nft} should deposit NFT to L2', async () => {
      // mint nft
    ...
    it('{tag:nft} should be able to transfer NFT on L2', async () => {
    ...
    it('{tag:nft} should not be able to withdraw non-owned NFT', async () => {
      await expect(
    ...
    it('{tag:nft} should withdraw NFT', async () => {
    ...
    it('{tag:nft} should deposit NFT to another L2 wallet', async () => {
    ...
    it('{tag:nft} should withdraw NFT to another L1 wallet', async () => {
    ...
    it('{tag:nft} should not be able to deposit unregistered NFT ', async () => {
    ...
    it('{tag:nft} should not be able to mint NFT on L2', async () => {
      await expect(
        L2ERC721.mint(env.l2Wallet.address, DUMMY_TOKEN_ID + 1)
      ).to.be.revertedWith('Only L2 Bridge can mint and burn')
    })

    it('{tag:nft} should not be able to burn NFT on L2', async () => {
  ...
  describe('L2 native NFT tests', async () => {
    ...
    it('{tag:nft} should exit NFT from L2', async () => {
      // mint nft
    ...
    it('{tag:nft} should be able to transfer NFT on L1', async () => {
    ...
    it('{tag:nft} should not be able to deposit non-owned NFT to L2', async () => {
      await expect(
    ...
    it('{tag:nft} should exit NFT to another L1 wallet', async () => {
      const approveTx = await L2ERC721.approve(L2Bridge.address, DUMMY_TOKEN_ID)
      await approveTx.wait()
    ...
    it('{tag:nft} should not be able to withdraw unregistered NFT ', async () => {
    ...
    it('{tag:nft} should not be able to mint NFT on L1', async () => {
      await expect(
        L1ERC721.mint(env.l1Wallet.address, DUMMY_TOKEN_ID + 1)
      ).to.be.revertedWith('Only L1 Bridge can mint and burn')
    })

    it('{tag:nft} should not be able to burn NFT on L1', async () => {
  ...
  describe('Bridges pause tests', async () => {
    ...
    it('{tag:nft} should pause and unpause L1 bridge', async () => {
      const mintTx = await L1ERC721.mint(env.l1Wallet.address, DUMMY_TOKEN_ID)
      await mintTx.wait()
      const approveTx = await L1ERC721.approve(L1Bridge.address, DUMMY_TOKEN_ID)
      await approveTx.wait()
    ...
    it('{tag:nft} should pause and unpause L2 bridge', async () => {
      const approveTx = await L2ERC721.approve(L2Bridge.address, DUMMY_TOKEN_ID)
      await approveTx.wait()
    ...
    it('{tag:nft} should not allow to pause bridges for non-owner', async () => {
    ...
    it('{tag:nft} should not allow to unpause bridges for non-owner', async () => {
      await expect(
  ...
  describe('Relay gas burn tests', async () => {
    ...
    it('{tag:nft} should not allow updating extraGasRelay for non-owner', async () => {
    ...
    it('{tag:nft} should allow updating extraGasRelay for owner', async () => {
      const mintTx = await L2ERC721.mint(env.l2Wallet.address, DUMMY_TOKEN_ID)
      await mintTx.wait()
      const approveTx = await L2ERC721.approve(L2Bridge.address, DUMMY_TOKEN_ID)
      await approveTx.wait()
    ...
    it('{tag:nft} should be able to exit with the correct added gas', async () => {
