...
func computeTxEnv(e *Ethereum, blockHash common.Hash, txIndex int, reexec uint64) (core.Message, vm.Context, *state.StateDB, error) {
  return NewPrivateDebugAPI(e).computeTxEnv(blockHash, txIndex, reexec)
}
